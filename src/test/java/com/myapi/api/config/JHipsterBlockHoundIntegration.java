...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.myapi.api.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.myapi.api.security.DomainUserDetailsService", "createSpringSecurityUser");
